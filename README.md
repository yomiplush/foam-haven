...
- Quest 3のハンドトラッキングにも対応。コントローラーを置くと素手に切り替わり、指で膜や風船に触れて押せます。人差し指でメニューを指し、親指と人差し指のピンチで決定/泡を出し、両手を同時にピンチするとメニュー、グーで握ると膜を押したり風船をつかめます。
...
- Quest 3のハンドトラッキングに対応。コントローラーを置いて素手になると、指で膜を押したりMRの風船を握ったり、人差し指でメニューを指してピンチで選択/泡生成ができます。両手同時ピンチでメニューの再表示。コントローラーを使う時の操作は今まで通りです。
